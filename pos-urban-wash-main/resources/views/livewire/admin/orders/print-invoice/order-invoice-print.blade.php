                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 mt-4">
                                ...
                                <p class="text-sm mb-1">
                                    ...
                                    <span class="fw-600 ms-2">{{ \Carbon\Carbon::parse($order->order_date)->format('d/m/Y') }}</span>
                                </p>
                                <p class="text-sm mb-3">
                                    <span> {{ $lang->data['delivery_date'] ?? 'Delivery Date' }}:
                                        <span class="fw-600 ms-2">{{ \Carbon\Carbon::parse($order->delivery_date)->format('d/m/Y') }}</span></span>
                                </p>
                                @if($order->nextday_order == 1)
                                <p class="text-sm mb-3">
                                    <span style="color:blue"> {{ $lang->data['nextday_order'] ?? 'Next Day Order' }}</span>

                                </p>
                                @endif
                                @if($order->urgent_order == 1)
                                <p class="text-sm mb-3">
                                    <span style="color:blue"> {{ $lang->data['urgent_order'] ?? 'Urgent Order' }}</span>

                                </p>
                                @endif

                                <p class="text-sm mb-3">
                                    <span> {{ $lang->data['collection_type'] ?? 'Collection Type' }}:</span>
                                    <span class="fw-600 ms-2">{{ $ordercollectiontype->name }}</span>
                                </p>
                                <div class="d-flex align-items-center">
                                    <div><span class="text-sm">
                                            {{ $lang->data['order_status'] ?? 'Order Status' }}:</span></div>
                                    <div class="dropdown ms-2">
                                        <button class="btn btn-xs bg-secondary  mb-0 text-white" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                            {{ getOrderStatus($order->status) }}
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <li><a class="dropdown-item" href="#" wire:click.prevent="changeStatus(1)">{{ $lang->data['processing'] ?? 'Processing' }}</a>
                                            </li>
                                            <li><a class="dropdown-item" href="#" wire:click.prevent="changeStatus(2)">{{ $lang->data['ready_to_deliver'] ?? 'Ready To Deliver' }}</a>
                                            </li>
                                            <li><a class="dropdown-item" href="#" wire:click.prevent="changeStatus(3)">{{ $lang->data['delivered'] ?? 'Delivered' }}</a>
                                            </li>
                                            <li><a class="dropdown-item" href="#" wire:click.prevent="changeStatus(4)">{{ $lang->data['returned'] ?? 'Returned' }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        @if (count($orderaddons) > 0)
                            ...
                            <div class="col-4 mb-3">
                                ...
                                <div class="">
                                    ...
                                    <div class="row mb-50 align-items-center">
                                        <div class="col text-sm">{{ $lang->data['special_discount'] ?? 'Special Discount' }}:
                                        </div>
                                        <div class="col-auto text-sm">{{ getCurrency() }}
                            ...
                            <div class="col-md-11">
                                ...
                                <p class="text-sm mb-0">T&C : {{ $tandc }}</p>
                            </div>
