...
{
    public $order,$orderdetails,$tandc,$orderaddons,$balance,$total,$customer,$payments,$sitename,$address,$phone,$paid_amount,$payment_type,$zipcode,$tax_number,$store_email,$from_date,$to_date;
    /* render the page */
    ...
    public function mount($id)
    {
        ...
        $this->ordercollectiontype = CollectionType::where('id',$this->order->collection_type)->first();
        ...
        if(isset($site['tandc']))
        {
            $tandc = (($site['tandc']) && ($site['tandc'] !=""))? $site['tandc'] : '';
            $this->tandc = $tandc;
        }
