...
const SectionCustomize = (props) => {
  ...
  //     currentPreview: "",
  //   });
  const [bottumimage, setBottumImage] = useState({
    preview: "",
    raw: "",
    currentPreview: "",
  });
  ...
  // console.log("bottumimage", bottumimage);
  ...
  const updateStore = () => {
    ...
    if (
      ...
      formData.append("navigationIcon", bottumimage.raw);
      formData.append("title", sectiontitle);
      formData.append("header", bannerhead);
      // console.log(formData);
      dispatch(loadingToggleAction(true));
      dispatch(
        createSliderSection(formData, props.store.id, SetLoader, history)
      );
    }
    // }
  };
                ...
                <div className="row">
                  ...
                  {/* <div className="col-5">
                    ...
                    <label htmlFor="upload-button1" className="upload-button">
                      {bottumimage.currentPreview !== "" ? (
                        <img
                          src={bottumimage.currentPreview}
...
export default connect(mapStateToProps)(SectionCustomize);
