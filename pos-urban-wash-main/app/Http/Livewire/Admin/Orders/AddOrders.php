...
{
    public $services,$nextday_order= 0,$urgent_order= 0,$collection_type,$location_address,$collectiontype,$search_query,$order_id,$spec_discount,$inputs = [],$selservices = [],$customer,$date,$delivery_date,$discount,$special_discount,$paid_amount,$payment_type;
    public $payment_notes,$service_types,$service,$inputi,$prices = [],$quantity = [],$selected_type,$addons,$selected_addons = [],$colors = [],$customitem = [];
    ...
    public function mount()
    {
        ...
        $this->collection_type = CollectionType::latest()->get();
    ...
    // public function changeCustomItem($id) {
    //     $this->customitem[$id]=$this->customitem[$id];
    // }
    ...
    { 
        ...
        elseif($name == 'collection_type' && $value == ''){
            $this->customers = collect();
        }
    ...
    public function selectService($id)
    {
        ...
        // $this->customitem[6]= $this->service->service_name;
    ...
    public function addItem()
    {
        ...
        if($this->service)
        {
            ...
            if($servicedetail)
            {
                ...
                $this->customitem[$this->inputi]= $this->service->service_name;
            }
    ...
    {   /* validation */
        ...
        $customer = Customer::create([
            ...
            'special_discount' => $this->spec_discount??0,
        ...
        $this->customer_name = '';
        $this->customer_phone = '';
        $this->spec_discount = $this->spec_discount;
        $this->email    = '';
        $this->tax_no = '';
        $this->address = '';
        $this->is_active = 1;
    ...
    public function selectCustomer($id)
    {
        ...
        $this->spec_discount = $this->selected_customer->special_discount;
        $this->customer_query = '';
        $this->customers = collect();
    ...
    public function calculateTotal()
    {
        ...
        if($this->nextday_order == 1)
        {
            
            $this->addon_total+=$this->sub_total/2;
        }
        if($this->urgent_order == 1)
        {
            
            $this->addon_total+=$this->sub_total*2;
        }
        $this->total = $this->sub_total + $this->addon_total - $this->discount - $this->spec_discount;
    ...
    public function save()
    {
        ...
        if($this->flag == 0)
        {
            ...
            $order = Order::create([
                ...
                'nextday_order'=>$this->nextday_order,
                'urgent_order'=>$this->urgent_order,
                'addon_total'   => $this->addon_total,
                'discount'  => $this->discount??0,
                'collection_type'=>($this->collectiontype == null)? 1: $this->collectiontype,
                'special_discount'  => number_format($this->spec_discount, 2),
            ...
            foreach($this->selservices as $key => $value)
            {
                ...
                OrderDetails::create([
                   ...
                   'service_name'  =>  $this->customitem[$key],
