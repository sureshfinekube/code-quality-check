            ...
            <div class="card mb-4">
                <div class="card-header p-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="date" id ="ordering_date" class="form-control" wire:model="date">
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row ms-2 align-items-center">
                                        <div class="col-4">
                                            ...
                                            <!-- <span
                                                ...
                                                <input type="text" class="text-xxs fw-600 text-primary" wire:model="customitem.{{ $key }}"   >
                    ...
                    <div class="modal-body">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-12 mb-1">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="{{ $lang->data['special'] ?? 'Enter Discount' }}"
                                    wire:model="spec_discount">
...
">
                            ...
                            <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                            wire:model="nextday_order" id="nextday_order">
                                        <label class="custom-control-label"
                                            for="nextday_order">{{ $lang->data['nextday_order'] ?? 'Next Day Order' }}</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                            wire:model="urgent_order" id="urgent_order">
                                        <label class="custom-control-label"
                                            for="urgent_order">{{ $lang->data['urgent_order'] ?? 'Urgent Order' }}</label>
                                    </div>
                                </div>
                                <hr>
                            <div class=" col-12">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        <input type="hidden" class="form-control"
                                            placeholder="{{ $lang->data['enter_special_discount'] ?? 'Enter Discount' }}"
                                            wire:model="spec_discount">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="row mb-50 align-items-center">
                                    <div class="col text-sm fw-500">{{ $lang->data['special_discount'] ?? 'special_discount' }}:</div>
                                    <div class="col-auto  text-sm fw-500">{{ getCurrency() }}
                                        {{ number_format($spec_discount, 2) }}</div>
                                </div>
                                <div class="row mb-50 align-items-center">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 mx-2 mb-1 " >
                                        <label
                                            class="form-label">{{ $lang->data['collection_type'] ?? 'Collection Type' }}</label>
                                        <select class="form-select" required="required" name="collectiontype" wire:model.defer="collectiontype">
                                        
                                        @foreach ($collection_type as $collection_types)
                                            <option  value="{{ $collection_types->id }}">
    ...
    document.addEventListener('livewire:load', function () {
        ...
        $('#ordering_date').attr('min', maxDate);
