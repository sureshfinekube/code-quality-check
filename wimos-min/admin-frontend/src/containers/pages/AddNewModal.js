  ...
  return (
    <Form>
      <Modal
        ...
        backdrop="static"
      >
        <ModalHeader toggle={toggleModal}>Create new Package</ModalHeader>
        <ModalBody>
...
const mapStateToProps = ({ adminData }) => {
  const { onCreatePackage, createPackageErr, createPackageSuccess } = adminData;
  return { onCreatePackage, createPackageErr, createPackageSuccess };
};
