...
{
    public $customers, $name,$location_address,$location_address1, $spec_discount, $email, $tax_number, $is_active = 1, $phone, $address, $search,$lang;
    ...
    public function store()
    {
        ...
        $customer->special_discount = $this->spec_discount;
        $customer->location_address = $this->location_address;
    ...
    public function edit($id)
    {
        ...
        $this->location_address1 = $this->customer->location_address;
        $this->name = $this->customer->name;
        $this->spec_discount = $this->customer->special_discount;
    ...
    public function update()
    {
        ...
        $this->customer->special_discount = $this->spec_discount;
        $this->customer->location_address = $this->location_address1;
