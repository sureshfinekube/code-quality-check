          ...
          <div className="col-lg-7">
            <div className="inner text-left">
              <div className="top-bid-price d-flex">
                ...
                <div className="last-bid color-primary">{price}</div>
              </div>
              <Anchor path={path}>
              ...
              <div className="product-share-wrapper lg-product-share">
                <div className="profile-share">
                  ...
                  <Anchor className="more-author-text" path={path}>
                    {bitCount}+ Place Bit.
                  </Anchor>
                </div>
              </div>
              ...
              <div className="rn-bet-create">
                  ...
                  <div className="top-seller-inner-one">
                    <div className="top-seller-wrapper">
                      <div className="thumbnail">
                        {highest_bid?.user?.image?.src && (
                          <Anchor path={highest_bid.user.path}>
                            <Image
                ...
                <div className="bid-list left-bid">
                  {!product?.isAuctionEnded ? (
                    <h6 className="title">Auction ended in</h6>
                  ) : (
                    // <h6 className="title">Auction ended</h6>
                    ""
                  )}
                  <CountdownTimer date={auction_date} className="mt--15" />
                </div>
              </div>
            ...
            <div className="property-wrapper-flex d-flex">
              <div className="rn-pd-sm-property-wrapper into-banner">
                ...
                <div className="catagory-wrapper">
                  {categories?.map((cat) => (
                    <div key={cat.id} className="pd-property-inner">
                      <span className="color-body type">{cat.type}</span>
                      <span className="color-white value">{cat.value}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="rn-pd-sm-property-wrapper into-banner ml--30">
                ...
                <div className="property-wrapper">
                  {properties?.map((prop) => (
                    <div key={prop.id} className="pd-property-inner">
                      <span className="color-body type">{prop.type}</span>
                      <span className="color-white value">{prop.value}</span>
                    </div>
                  ))}
                </div>
              </div>
