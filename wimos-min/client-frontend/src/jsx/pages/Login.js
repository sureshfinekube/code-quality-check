...
function Login(props) {
  ...
  return (
    <div className="authincation d-flex flex-column flex-lg-row flex-column-fluid">
      <div className="login-aside align-items-center   d-flex flex-column flex-row-auto">
        <div className="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
          <div className=" mb-4 pt-5 logo-img">
            <img src={logo} alt="" style={{ width: "48%" }} />
          </div>
          {/* <h3 className="mb-2">Welcome wimos</h3> */}
          {/* <p>caption</p> */}
        </div>
        <div
        ...
        >
          <Player
            ...
            loop={true}
            controls={true}
            src="https://assets5.lottiefiles.com/packages/lf20_dggorkd9.json"
                  ...
                  <form onSubmit={onLogin} className="form-validate">
                    ...
                    <div className="text-center form-group mb-3">
                      ...
                      >
                        ...
                        {!props.showLoading && <span>Sign In</span>}
                      </button>
                    </div>
                  </form>
