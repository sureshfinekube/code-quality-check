                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto mt-4">
                            ...
                            <p class="text-sm mb-3">
                                ...
                                <span
                                    class="fw-600 ms-2">{{ $ordercollectiontype->name }}</span>
                            </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="">
                                ...
                                <div class="row mb-50 align-items-center">
                                    <div class="col text-sm">{{ $lang->data['special_discount'] ?? 'Special Discount' }}:</div>
                                    <div class="col-auto text-sm">{{ getCurrency() }}
                                        {{ number_format($order->special_discount, 2) }}</div>
                                </div>
