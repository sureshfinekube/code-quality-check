...
{
    public $default_currency,$tandc,$default_application_name,$default_phone_number,$default_financial_year,$default_tax_percentage;
    ...
    public function mount()
    {
        ...
        $this->tandc = (isset($site['tandc']) && !empty($site['tandc'])) ? $site['tandc'] : '';
