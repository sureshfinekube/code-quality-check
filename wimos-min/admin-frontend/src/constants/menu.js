...
const data = [
  {
    ...
    subs: [
      ...
      //   label: 'menu.packages-list',
      //   to: `${adminRoot}/dashboards/packages-list`,
      // },
    ],
  },
  {
    ...
    subs: [
...

      {
        ...
        label: "menu.packages",
        to: `${adminRoot}/pages/manage/packages`,
      },
      {
        icon: "simple-icon-people",
        label: "menu.clients",
        to: `${adminRoot}/pages/manage/clients`,
      },
      {
        icon: "simple-icon-globe",
        label: "menu.domains",
        to: `${adminRoot}/pages/manage/domains`,
      },
      // {
      //   icon: "simple-icon-note",
      //   label: "menu.features",
      //   to: `${adminRoot}/pages/manage/features`,
      // },
      {
        icon: "simple-icon-basket",
        label: "menu.stores",
        to: `${adminRoot}/pages/manage/stores`,
      },
      // {
      //   icon: "simple-icon-people",
      //   label: "menu.customers",
      //   to: `${adminRoot}/pages/manage/customers`,
      // },
      {
        icon: "simple-icon-book-open",
        label: "menu.contracts",
        to: `${adminRoot}/pages/manage/contracts`,
      },
    ...
    subs: [
      {
        icon: "simple-icon-user-following",
        label: "menu.profile",
        to: `${adminRoot}/dashboards/changepassword`,
      },
      // {
